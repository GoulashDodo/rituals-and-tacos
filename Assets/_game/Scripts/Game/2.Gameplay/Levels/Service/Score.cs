...
namespace _game.Scripts.Game._2.Gameplay.Levels.Service
{
    public class Score
    {
        ...
        private void OnRitualCompleted(RitualSettings ritualSettings)
        {
            AddScoreBasedOnRitual(ritualSettings);
        ...
        private void AddScoreBasedOnRitual(RitualSettings ritualSettings)
        {
            AddScore((int)ritualSettings.RiteDifficulty);
        }
